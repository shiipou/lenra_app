...
module.exports = {
    ...
    getData(api, datastore, id) {
        return axios.get(`${api.url}/app/datastores/${datastore}/data/${id}`, options(api)).then(handleResponse, handleError);
    },
    /**
    ...
    updateData(api, datastore, data) {
        return axios.put(`${api.url}/app/datastores/${datastore}/data/${data._id}`, data, options(api)).then(handleResponse, handleError);
    },
    /**
    ...
    createData(api, datastore, data) {
        return axios.post(`${api.url}/app/datastores/${datastore}/data`, data, options(api)).then(handleResponse, handleError);
    },
    /**
    ...
    deleteData(api, datastore, id) {
        return axios.delete(`${api.url}/app/datastores/${datastore}/data/${id}`, options(api)).then(handleResponse, handleError);
    },
    /**
     * Creates a datastore
     * @param {*} api The API call data
    ...
    createDatastore(api, datastore) {
        return axios.post(`${api.url}/app/datastores`, { "name": datastore }, options(api)).then(handleResponse, handleError);
    },
    /**
    ...
    executeQuery(api, query) {
        return axios.post(`${api.url}/app/query`, query, options(api)).then(handleResponse, handleError);
    }
}
...
function handleError(error) {
    console.error("Data API call error", error);
    throw error;
}
